#!/bin/bash
#SBATCH --job-name='P2-1-c2_a100k_o2k_i100_u40_p26.h5'
...
DATASET_FILE="c2_a100k_o2k_i100_u40_p26.h5"
REMOVE_DATASET="YES"
## Main dataset name
DATASET_NAME="dados"
...
sbatch P2-1-c2_a1M_o1k_i100_u40_p26.h5.1692308681940041414.sh
